#################################################################################################################
#################################################################################################################
### A.Read_data/A1.Descriptives_disc.R
...
rm(list=ls())
.res <- paste0(.res0, "A.Read_data/A1.Descriptives_disc/")
dir.create(.res, F, T)

#################################################################################################################
  # Descriptives for DIA/DDA series - All
  # - All HUPT
...
r <- r[!r[, 3]%in%c("Male", "IRSICaixa", "No"), ]
...
p <- openPage(paste0(.res,  "Descriptives_discovery_all.html"))
hwrite(paste0('<br><br>Descriptives - Univariate association with condition group - Discovery<br><br>',
...
#################################################################################################################
  # Descriptives for DIA series - patients
...
p <- openPage(paste0(.res,  "Descriptives_discovery_hosp.html"))
hwrite(paste0("<br><br>Descriptives - Univariate association with condition group - Discovery - ",
