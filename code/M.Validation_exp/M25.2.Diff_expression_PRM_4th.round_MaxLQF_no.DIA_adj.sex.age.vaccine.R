#################################################################################################################
#################################################################################################################
### M25.2.Diff_expression_PRM_4th.round_MaxLQF_no.DIA_adj.sex.age.vaccine.R
...
rm(list=ls())
.res <- paste0(.res0, "M.Validation_exp/M25.2.Diff_expression_PRM_4th.round_MaxLQF_no.DIA_adj.sex.age.vaccine/")
dir.create(.res, F, T)
...
rm(list=ls())
nd <- readRDS(paste0(.dat, "2_PRM/nd.prot.no0.norm.area.maxlfq.round4.rds"))
